...
//            holder = new CollectsAdapter.CollectsViewHolder(View.inflate(mContext, R.layout.item_collect, null));
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == I.TYPE_FOOTER) {
            ...
            CollectsAdapter.CollectsViewHolder gvh = (CollectsAdapter.CollectsViewHolder) holder;
